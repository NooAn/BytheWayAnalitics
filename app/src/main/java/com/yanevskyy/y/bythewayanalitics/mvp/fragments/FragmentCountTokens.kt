...
import com.yanevskyy.y.bythewayanalitics.mvp.presenter.CountTokensPresenter
...
class FragmentCountTokens : BaseFragment<FragmentCountTokensView>(), FragmentCountTokensView {
    ...
    override fun takeListTokens(tokes: ArrayList<String>) {
        sendButtonText.setOnClickListener {
            presenter.sendText(editTextMessage.text.toString())
        }
    }
}